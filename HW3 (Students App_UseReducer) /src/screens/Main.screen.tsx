...
const Main = (props: IProps) => {
  ...
  useEffect(() => {
    setFilteredList(
      studentsList.filter(
        (student) => student.absents >= minAbs && student.absents <= maxAbs
      )
    );
  }, [maxAbs, minAbs, studentsList]);
  ...
  const handleMinAbsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    params.set("minAbs", e.target.value);
    setParams(params);
  };

  const handleMaxAbsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    params.set("maxAbs", e.target.value);
    setParams(params);
  };
    ...
    <div className="main-screen">
      ...
      <div className="filter">
        ...
        <div>
          <label>
            Min Abs:
            <input type="number" value={minAbs} onChange={handleMinAbsChange} />
          </label>
          <label>
            Max Abs:
            <input type="number" value={maxAbs} onChange={handleMaxAbsChange} />
          </label>
        </div>
        <div>
